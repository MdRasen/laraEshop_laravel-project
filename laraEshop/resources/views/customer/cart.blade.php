                    ...
                    <tbody>
                        ...
                        <tr class="text-center">
                            <td><img class="table-img"
                                    src="{{asset('storage/product_images')}}/{{$item->product->thumbnail}}" alt="image">
                            </td>
                            <td>
                            ...
                            <td>
                                <a href="{{route('customer.cart-decrement', ['cartitem_id'=>$item->id])}}"
                                    class="btn btn-sm btn-danger"> - </a>
                                <button class="btn btn-sm">{{$item->quantity}}</button>
                                <a href="{{route('customer.cart-increment', ['cartitem_id'=>$item->id])}}"
                            ...
                            <td>
                                ...
                                <button type="button" value="{{$item->id}}"
                                    class="nav-link btn btn-sm btn-danger deleteProductBtn" data-toggle="modal"
                                    data-target="#deleteProductBtn">Remove</button>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="{{route('customer.cart-remove-item')}}" method="POST">
                                                    @csrf
                                                    <input type="text" id="product_id" name="cart_item_id"
                                                        class="form-control">
